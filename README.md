...
- Which of this README's instructions you can execute fully, which only partially, and which not at all.
...
- `readme_deviations`: every place you adapted this README's process in Phase 0, and why.
